...
> The repository provides an extended technical report ([**`Technical_Report.pdf`**](./Technical_Report_0_95.pdf)) to address reviewer feedback and provide complete mathematical derivations, system models, and extended benchmarks.
> 
