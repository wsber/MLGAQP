...
# MODEL_DIR = f"../AIModels/NLP/NLI/{model_name}"  # 你的模型与 tokenizer 保存目录
MODEL_DIR = f"../AIModels/Finetune/NLI/base/{model_name}"  # 你的模型与 tokenizer 保存目录
INPUT_CSV = "../datasets/parler_data/dataset_three/csv_data/post.csv"  # 待推理的文件
OUTPUT_CSV = "../datasets/parler_data/dataset_three/csv_data/post.csv"  # 覆盖写回
BATCH_SIZE = 32
MAX_LEN = 256
