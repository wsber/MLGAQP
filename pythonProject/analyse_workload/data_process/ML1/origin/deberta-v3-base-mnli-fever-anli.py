...
# 1. 配置部分
# ————————————————
model_dir = '/home/wangshuo/resource/AIModels/NLP/NLI/deberta-v3-base-mnli-fever-anli'
...
print('[check] all_probs shape:', all_probs.shape)
contra_plus_entail = all_probs[:, 0] + all_probs[:, 2]
# 避免除以零
df['ML1_proxy5_probability'] = np.where(
    contra_plus_entail > 0,
    all_probs[:, 0] / contra_plus_entail,
    0.0
)
