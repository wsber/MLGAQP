import numpy as np
import torch
import torch.nn as nnimport util_trt
import glob,os,cv2
...
height = 640  # 输入高度
width = 640  # 输入宽度
CALIB_IMG_DIR = '/home/wangshuo/resource/AI-Models/CV/yolov5/new_model_qua/calibrationData/val2017_sub'  # 校准图片路径
onnx_model_path = '/home/wangshuo/resource/AI-Models/CV/yolov5'  # 待校准onnx模型路径
