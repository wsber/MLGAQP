...
INPUT_CSV = "/home/wangshuo/resource/datasets/parler_data/30W_valid_user/10-10-5/post.csv"  # 待推理的文件
OUTPUT_CSV = "/home/wangshuo/resource/datasets/parler_data/30W_valid_user/10-10-5/post.csv"  # 覆盖写回
BATCH_SIZE = 32
MAX_LEN = 256
...
# —————— 写回结果 ——————
df['ML1_proxy6b1_probability'] = proxy_probs
