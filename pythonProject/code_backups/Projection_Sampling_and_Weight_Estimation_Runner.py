...
# dataset_name = "amazon"
# 原始CSV数据路径
CSV_BASE_DIR = base_dir + f"datasets/{dataset_name}/csv_data"
# 转换后GraphLib数据存放路径
Graph_Lib_Dir = base_dir + f"datasets/{dataset_name}/data_graph"

runner = FastestRunner(build_dir="/home/wangshuo/projects/PROXY/cProject/build")
print(dataset_name)
sample_budget = 60000
extra_args = ["--BASE_DIR", f"{base_dir}datasets","--AGG_FUNC","count"]
