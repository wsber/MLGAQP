...
ans_file_path = f"../../../datasets/{parent_dataset}/ground_truth/parler_ans_{agg_mode}.txt" 
# ==========================================
# 2. 初始化与数据加载
# ==========================================
